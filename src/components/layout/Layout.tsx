...
const Layout: React.FC = () => {
    ...
    const accentColor = '#008069';
    const accentBg = 'rgba(0,128,105,0.08)';
    const accentBgHover = 'rgba(0,128,105,0.12)';
        ...
        <Box sx={{ height: '100%', display: 'flex', flexDirection: 'column', background: '#FFFFFF' }}>
            ...
            <Box sx={{
                ...
                <Box sx={{
                    ...
                    background: `linear-gradient(135deg, ${accentColor}, #005c4b)`,
            ...
            {/* User Footer — no logout button, only profile info */}
                ...
                <Toolbar sx={{ minHeight: '60px !important' }}>
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                        <Box sx={{
                            ...
                            <Box sx={{ width: 7, height: 7, borderRadius: '50%', background: '#00a884', animation: 'pulse 2s infinite', '@keyframes pulse': { '0%, 100%': { opacity: 1 }, '50%': { opacity: 0.5 } } }} />
                    ...
                    <Menu
                        ...
                        PaperProps={{
                            sx: {
                                ...
                                minWidth: 200, borderRadius: '12px',
                            }
                        }}
                    >
                        <Box sx={{ px: 2, py: 1.5 }}>
